...
<div class="row" style="width: 550px;margin: auto;padding: 10px">
    <div class="col-sm-12">
        ...
        <form id="addSecondCategroy" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="parentId" name="fatherId" placeholder="该类目所属父级类目">
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        $("#category_addSecondLevel").panel("close");
