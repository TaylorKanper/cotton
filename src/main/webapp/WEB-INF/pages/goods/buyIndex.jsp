                ...
                <div class="col-sm-12">
                    ...
                    <div id="tb">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-info"><i class="fa fa-buysellads"></i> 购买勾选
                            </button>
                            <button type="button" class="btn btn-sm btn-success"><i class="fa fa-buysellads"></i> 批量购买
                            </button>
                            <button type="button" class="btn btn-sm btn-danger"><i class="fa fa-shopping-cart"></i>
                                添加购物车
                            </button>
                            <button type="button" class="btn btn-sm btn-primary"><i class="fa fa-shopping-bag"></i>
                                查看购物车
                            </button>
                        </div>
                    </div>
...
<div id="multiBuy" class="hidden">
    <div class="container-fluid">
        <h4 class="text-center">商品库存 <span></span></h4>
        <form class="form-horizontal" role="form" id="multiBuyGoods" method="post" style="margin-top: 10px">
            <input type="hidden" name="id">
            <div class="form-group">
                <label for="goods_buyNumber" class="col-sm-4 control-label">购买数量</label>
                <div class="col-sm-8">
                    <input type="number" class="form-control" id="goods_buyNumber" name="number"
                           placeholder="请输入购买商品数量..." min="1">
                </div>
            </div>
            <div class="form-group">
...
<div id="shopCartInfo"></div>
<jsp:include page="/common/footer.jsp"></jsp:include>

<script src="${ROOT}/js/goods/buyIndex.js"></script>
</body>
</html>
